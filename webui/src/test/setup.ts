...
// PNG, every image is 64x64, crops pass the bytes through, and the thumbnail
// is a tiny WebP-headed blob.
...
setImageOpsForTests({
  ...
  cropToPng: async (blob) => new Blob([await blob.arrayBuffer()], { type: 'image/png' }),
});
